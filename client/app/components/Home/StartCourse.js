  ...
  render() {
    return (
      <div className="col-12">
        <div className="embed-responsive embed-responsive-16by9 mt-3 col-lg-10 offset-lg-1 col-md-12">
        ...
        <div className="card m-3 bg-transparent">
          ...
          <TabContent className="mt-2" activeTab={this.state.activeTab}>
            ...
            <TabPane tabId="2">
              <Row>
                <Col sm="12">
                  <h5>Egypt, a country linking northeast Africa with the Middle East, dates to the time of the pharaohs. Millennia-old monuments sit along the fertile Nile River Valley, including Giza's colossal Pyramids and Great Sphinx as well as Luxor's hieroglyph-lined Karnak Temple and Valley of the Kings tombs. The capital, Cairo, is home to Ottoman landmarks like Muhammad Ali Mosque and the Egyptian Museum, a trove of antiquities.</h5>
                </Col>
              </Row>
            </TabPane>
            <TabPane tabId="3">
